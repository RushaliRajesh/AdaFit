...
def vis(w_betas2, save_ind):
    ...
    rind = np.random.randint(0, w_betas2.shape[0])
    plt.figure()
    for i in range(0,w_betas2.shape[1], 10):
        y = w_betas2[rind, i, :]
...
def fit_Wjet(points, weights, order=2, compute_neighbor_normals=False, w_betas = None, save_ind = None):
    """
